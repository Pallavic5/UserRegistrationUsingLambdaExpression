...
/*
 * Problem Statement UC13 - Refactor the Code to use Lambda Function to validate User Entry
...
public class UserEntry {
	...
	interface Validation {
		...
		//create new method to refactor the code in LambdaExpression
	public static void validateUserEntry() {
